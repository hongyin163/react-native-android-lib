...
var ToolbarAndroid = React.createClass({
  ...
  propTypes: {
    ...
    menuVisible:ReactPropTypes.bool,
  },
  showMenu:function () {
    this._tool.setNativeProps({
      menuVisible:true
    });
  }, 
  render: function() {
    ...
    return <NativeToolbar  ref={(control)=>{this._tool=control}}   onSelect={this._onSelect} {...nativeProps} />;
  },
...
var NativeToolbar = requireNativeComponent('ManToolbar', ToolbarAndroid, {
  nativeOnly: {
    nativeActions: true,
  }
});
